...
const Pricing = () => {
    return (
      <div className='w-full mx-auto px-10 sm:w-[80%]'>
            <section className='mb-20'>
            <div className='text-center  mx-auto'>
            <h1 className='mb-4 text-5xl font-bold'>Donate Today</h1>
            <p className='mb-10 text-xl w-full sm:w-[50%] mx-auto text-thin'>Lorem ipsum dolor, sit amet consectetur adipisicing elit. Dicta quia ab  minima eligendi! Ratione laudantium reprehenderit esse. Aperiam, repellat beatae.</p>
            <div className='mx-auto'>
                <div className='flex flex-col  sm:m-0 sm:flex-row justify-center sm:mx-0 mx-10 mb-4'>
